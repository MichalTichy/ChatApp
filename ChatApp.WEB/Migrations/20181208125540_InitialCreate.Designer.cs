...
namespace ChatApp.WEB.Migrations
{
    ...
    [Migration("20181208125540_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.WEB.DAL.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ChatApp.WEB.DAL.GroupMembership", b =>
                {
                    b.HasOne("ChatApp.WEB.DAL.Group", "Group")
                        .WithMany()
                        .HasForeignKey("GroupId");

                    b.HasOne("ChatApp.WEB.DAL.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ChatApp.WEB.DAL.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
